...
INTERIM_INPUTS = (
    ...
    "data/interim/gem_lng_carriers_metadata.json",
)
...
def _package_versions() -> dict[str, str]:
    out = {}
    for package in (
        "matplotlib", "numpy", "openpyxl", "pandas", "pytest", "requests",
        "PyYAML", "searoute",
    ):
        try:
...
def verify_manifest(root: Path) -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="hormuz_throughput-manifest-") as temp_dir:
