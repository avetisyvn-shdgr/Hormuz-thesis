...
**Design SHA-256:** `5b4247512ca698020102a3a9cb11f0f1b39f3782d05c57070e0637b3d7e88503`  
...
All 5 candidates carry a non-GO status and all require an explicit written scope reopening by Mher, recorded in `DECISION_LOG.md` **before** any acquisition.
...
- Acquisition before an explicit written scope reopening by Mher.
...
- Authority to reopen scope rests with Mher only, by explicit written scope reopening.
