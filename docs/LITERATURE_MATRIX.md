...
| 3 | Nguyen et al. 2023 [nguyen2023review] | How does the literature manage maritime-industry disruptions? | Systematic literature review | Published corpus | Response-strategy taxonomy | Systematic review | Classifies disruption-management responses △ (exact categories unconfirmed — audit flag) | Review; no primary event data | Data: n/a (review); Artifact: n/a | Background for resilience vocabulary; **do not** attribute a specific 4-category taxonomy until full text checked |
...
1. Scopus/Web of Science Boolean runs (institutional login) before claiming
   exhaustive coverage.
2. Resolve every **△** by full-text screening — especially Polemis method detail
