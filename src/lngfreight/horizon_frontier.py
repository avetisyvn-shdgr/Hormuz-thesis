...
def frontier_capacity(n_blocks: int, levels) -> dict:
    ...
    return {
        ...
        # Whether the FLOOR is small enough to permit a 0.05 value at all. This
        # is a property of the reference partition, never a significance claim:
        # a finer resolution lowers the floor while also shortening the window
        # each block measures.
