...
#
# Everything below replaces the legacy sampler's inference. The legacy function
# above is preserved so the published result stays reproducible, but it draws
# pseudo-onsets WITH replacement behind a single hard-coded guard, which plan
# v1.1 section 7 forbids for B2.
# ---------------------------------------------------------------------------
