...
def load_measurement_state_panel(
    ...
    *,
    ...
    here.
    """
    from .registry import RegisteredArtifact, get_variable  # deferred: registry imports config
    ...
    if lock is not None and hormuz in panel.columns and panel.index.max() >= surveillance:
        # This is the boundary the whole phase turns on.
